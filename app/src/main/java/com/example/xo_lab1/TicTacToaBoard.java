...
public class TicTacToaBoard extends View {
    ...
    public TicTacToaBoard(Context context, @Nullable AttributeSet attrs) {
        ...
        try{
            boardColor = a.getInteger(R.styleable.TicTacToaBoard_boardColor,0);
            XColor = a.getInteger(R.styleable.TicTacToaBoard_XColor,0);
            OColor = a.getInteger(R.styleable.TicTacToaBoard_OColor,0);
    ...
    private void drawVerticallLine(Canvas canvas, int row, int col){
    ...
    private void drawWinningLine(Canvas canvas){
        ...
        switch (game.getWinType()[2]){
            case 1:
                ...
                break;
            case 2:
                drawVerticallLine(canvas, row, col);
                break;
            case 3:
